...
import "package:flutter_application_test/data/http_helper.dart";
...
class _WeatherState extends State<Weather> {
  WeatherData result = WeatherData('', '', 0, 0, 0, 0, '');
    ...
    return Scaffold(
        ...
        body: Padding(
          ...
          child: ListView(children: [
            ...
            weatherRow(
                'Temperature: ', '${result.temperature.toStringAsFixed(2)}ºC'),
            weatherRow(
                'Perceived: ', '${result.perceived.toStringAsFixed(2)}ºC'),
